...
```text
dev-docs/schemas/stt-worker-request.v1.json
dev-docs/schemas/stt-worker-response.v1.json
dev-docs/schemas/stt-worker-error.v1.json
...
```text
dev-docs/go-docs/specs/round10-go-product-core.md
```
...
```text
dev-docs/go-docs/specs/round10-5-go-daemon-job-api.md
```
...
```text
dev-docs/go-docs/specs/daemon-api.md
```
