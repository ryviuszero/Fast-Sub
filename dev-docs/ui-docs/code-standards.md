...
- 原型视觉来自 `dev-docs/ui-docs/prototype`，生产 UI 应保留其信息架构和用户可见状态，但实现可整理为正式组件。
...
- `dev-docs/ui-docs/` — UI 规划、项目总览、架构、代码标准和产品流程文档。
- `dev-docs/ui-docs/prototype/` — 当前 Vite/React 原型和 artboards，仅作为设计参考。
