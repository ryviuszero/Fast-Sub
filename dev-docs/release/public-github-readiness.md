...
- Windows preview release notes and SHA256 checksums are recorded in `dev-docs/release/v0.13.2.md`; macOS arm64 preview checksums remain recorded in `dev-docs/release/v0.13.0.md` until the next macOS release-machine build.
