...
export const baseProviders: ProviderStatus[] = [
  ...
  { id: "api-openai-chat", name: "OpenAI 兼容翻译 API", kind: "api", capability: "translation", state: "missing_api_key", enabled: false, privacyNote: "会上传字幕文本，可能产生费用。", requiresUploadConfirmation: true, requiresApiKey: true, supportsBatch: true, supportedLanguages: ["auto", "en", "zh", "ja", "ko"], capabilities: ["translate_srt", "remote_api"], maskedCredential: "未配置" }
];
