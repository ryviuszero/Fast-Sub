...
| --- | --- | --- |
| Windows x64 installer | Release candidate | `FastSub-Desktop-0.13.0-windows-x64.exe`; smoke tested as an unsigned build. |
| Windows x64 portable zip | Release candidate | `FastSub-Desktop-0.13.0-windows-x64.zip`; smoke tested as an unsigned build. |
...
SHA256 checksums for `0.13.0` are listed in the project release notes:

- [Release notes](release-notes.md)
- [Developer release record](https://github.com/ryviuszero/Fast-Sub/blob/master/dev-docs/release/v0.13.0.md)
