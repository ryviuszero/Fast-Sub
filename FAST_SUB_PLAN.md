...
- [ ] `bench-assets` 真实 benchmark 数据准备与受控下载器，详见 `FAST_SUB_PARALLEL_ROUND5_5.md`。
...
- 第 5.5 轮：真实 benchmark 数据准备与受控下载器。目标是用 manifest 记录官方来源、许可证、download policy 和 checksum，让 `bench` 有稳定、合法、可复现的本地输入数据。
