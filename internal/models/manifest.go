...
func BuiltInManifest() Manifest {
	return Manifest{SchemaVersion: 1, Models: []ManifestEntry{
		...
		{
			ID:                  "whispercpp-base",
			Name:                "Whisper Base GGML for whisper.cpp",
			Type:                "asr",
			Backend:             "whisper.cpp",
			ArtifactKind:        "model",
			CompatibleProviders: []string{"local-whisper-cpp"},
			Revision:            "80da2d8bfee42b0e836fc3a9890373e5defc00a6",
			SizeBytes:           147951465,
			License:             "MIT",
			LicenseURL:          "https://huggingface.co/ggerganov/whisper.cpp",
			URLs:                []string{"https://huggingface.co/ggerganov/whisper.cpp/resolve/80da2d8bfee42b0e836fc3a9890373e5defc00a6/ggml-base.bin"},
			SHA256:              "60ed5bc3dd14eea856493d334349b405782ddcaf0028d4b5df4088345fba2efe",
			DefaultFor:          []string{"local-whisper-cpp"},
			PrivacyClass:        "local",
			InstallLayout:       "file",
			SourceType:          "http",
			Platforms:           []string{"all"},
			MinDiskFreeBytes:    155349039,
			EstimatedRAMBytes:   1073741824,
		},
		{
			ID:                  "whispercpp-small",
			Name:                "Whisper Small GGML for whisper.cpp",
			Type:                "asr",
			Backend:             "whisper.cpp",
			ArtifactKind:        "model",
			CompatibleProviders: []string{"local-whisper-cpp"},
			...
			License:             "MIT",
			LicenseURL:          "https://huggingface.co/ggerganov/whisper.cpp",
			URLs:                []string{"https://huggingface.co/ggerganov/whisper.cpp/resolve/80da2d8bfee42b0e836fc3a9890373e5defc00a6/ggml-small.bin"},
			SHA256:              "1be3a9b2063867b937e64e2ec7483364a79917e157fa98c5d94b5c1fffea987b",
			PrivacyClass:        "local",
			InstallLayout:       "file",
			SourceType:          "http",
			Platforms:           []string{"all"},
			MinDiskFreeBytes:    511982065,
			EstimatedRAMBytes:   2147483648,
		},
		{
			ID:                  "whispercpp-large-v3-turbo-q5_0",
			Name:                "Whisper Large v3 Turbo Q5_0 GGML for whisper.cpp",
			Type:                "asr",
			Backend:             "whisper.cpp",
			ArtifactKind:        "model",
			CompatibleProviders: []string{"local-whisper-cpp"},
			...
			License:             "MIT",
			LicenseURL:          "https://huggingface.co/ggerganov/whisper.cpp",
			URLs:                []string{"https://huggingface.co/ggerganov/whisper.cpp/resolve/98aa99a0a9db05ae2342309f5096248665f7cba3/ggml-large-v3-turbo-q5_0.bin"},
			SHA256:              "394221709cd5ad1f40c46e6031ca61bce88931e6e088c188294c6d5a55ffa7e2",
			PrivacyClass:        "local",
			InstallLayout:       "file",
			SourceType:          "http",
			Platforms:           []string{"all"},
			MinDiskFreeBytes:    602743255,
			EstimatedRAMBytes:   3221225472,
		},
		{
