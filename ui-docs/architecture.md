...
| 原型来源 | `ui-docs/prototype` | 提供视觉、文案、状态和信息架构参考 | 原型不是运行时 contract；真实 contract 来自 client types 和 daemon schema |
...
Electron 应用的页面结构参考 `ui-docs/prototype/v2/app.jsx` 中的 artboard 分区。
