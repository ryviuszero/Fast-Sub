...
1. 规划/原型分支：
   ...
   - 该分支用于审阅 `ui-docs`、prototype、UI context、Round 11 spec 和 tracker。
...
- 分支内每完成一个 unit，都必须更新 `ui-docs/project-tracker.md`，记录完成内容、验证命令、剩余问题和下一步。
...
Round 11 拆成以下小单元推进。每个单元完成后都要更新 `ui-docs/project-tracker.md`。
...
- Round 11 拆分单元的完成状态已同步到 `ui-docs/project-tracker.md`。
